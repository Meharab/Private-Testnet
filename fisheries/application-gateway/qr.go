...
var (
	...
	chaincodeName   = envOrDefault("CHAINCODE_NAME", "fisheries")
...
func createAsset(contract *client.Contract, productId string) error {
    asset := map[string]interface{}{
        ...
        "processing_type_en": "Frozen",
        "processing_type_bn": "Frozen",
        ...
        "source_of_fish_en": "Padma River",
        "source_of_fish_bn": "Padma River",
        ...
        "fish_collection_center_latitude": 23.90,
        "fish_collection_center_longitude": 90.44,
        "collector_organization_en": "Dhaka Fish Collectors",
        "collector_organization_bn": "Dhaka Fish Collectors",
        "fish_processing_unit_latitude": 23.75,
        "fish_processing_unit_longitude": 90.39,
